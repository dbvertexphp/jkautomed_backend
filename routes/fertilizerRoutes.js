...
const { addFertilizer, getProducts, editProduct, deleteFertilizer, updateDeleteStatus, getFertilizerById, getOrdersBySupplierId, updateOrderItemStatus, getAllFertilizer, getProductsBySupplierId } = require("../controllers/fertilizerController.js");
...
fertilizerRoutes.put("/updateDeleteStatus", protect, Authorization(["supplier", "both", "admin"]), updateDeleteStatus);
